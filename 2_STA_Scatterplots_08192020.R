...
setwd("C:/Users/lukel/Documents/R/CHEPs_Ageing/2_Chep_Ageing/")
...
c1 <- cor.test(CV_NB_C4$NRS,CV_NB_C4$N2P2_Amplitude)
c1
...
f1 <- ggplot(data = CV_NB_C4, aes(x=NRS, y=N2P2_Amplitude, shape=Dermatome_new,color=Dermatome_new))+
  ...
  stat_poly_eq(formula = my.formula,eq.with.lhs = "italic(y)~`=`~",
               coef.digits=2, rr.digits=2, p.digits=2,
...
ggsave(fn, filename = "NRS_N2P2_Scatters_R1.pdf", device=cairo_pdf, width=6,height=8,units="in")
...
f3 <- ggplot(data = CV_NB_C6, aes(x=Age, y=N2P2_Amplitude, shape=Dermatome_new,color=Dermatome_new))+
  ...
  theme(panel.border=element_blank(), panel.grid.major=element_blank(), 
        panel.grid.minor = element_blank(), axis.line=element_line(colour="black"),
        plot.title = element_text(family = "Times New", size = 14, face = "bold", hjust = 0.5), 
        axis.text.x = element_text(family = "Times", size = 12), 
        axis.text.y = element_text(family = "Times", size = 12), 
        axis.title.y = element_text(family = "Times", size = 12), 
        axis.title.x = element_text(family = "Times", size = 12),
...
ggsave(fn, filename = "Age_N2P2_Scatters_R1.pdf", device=cairo_pdf, width=6,height=8,units="in")
...
ggsave(fn, filename = "Age_N2_Scatters_R1.pdf", device=cairo_pdf, width=6,height=8,units="in")
...
ggsave(fn, filename = "Age_P2_Scatters_R1.pdf", device=cairo_pdf, width=6,height=8,units="in")
